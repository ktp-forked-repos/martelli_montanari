...
write('----------------------------------------------------------------\n'),
write('Unification de : [f(X,g(y,z),a)?=f(g(v,z),x,z)] (non unifiable)'),
...
premier :- 
write('choix_premier : \n'),
trace_unif([f(X,g(y,z),a)?=f(g(v,z),x,z)],choix_premier),
read(_).

pondere :- write('choix_pondere : \n'),
trace_unif([f(X,g(y,z),a)?=f(g(v,z),x,z)],choix_pondere),
read(_).

aleatoire :- 
write('choix_aleatoire : \n'),
trace_unif([f(X,g(y,z),a)?=f(g(v,z),x,z)],choix_aleatoire),
read(_).
